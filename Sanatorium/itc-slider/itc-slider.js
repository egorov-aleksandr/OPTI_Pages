...
class ItcSlider {
  ...
  static CLASS_CONTROL_R = 'slider__control_r';
  ...
  static SEL_PREV_R = '.slider__control_r[data-slide="prev"]';
  static SEL_NEXT_R = '.slider__control_r[data-slide="next"]';
  ...
  static createInstances() {
    document.querySelectorAll('[data-slider="itc-slider"]').forEach((el) => {
      ...
      this.contains.push({ el, slider: new ItcSlider(el, params) });
      el.dataset.sliderId = this.contains.length;
      el.querySelectorAll('.slider__control_r').forEach((btn) => {
        btn.dataset.sliderTarget = this.contains.length;
      });
    });
  }
  ...
  constructor(selector, config) {
    ...
    this._btnPrevr = this._el.querySelector(ItcSlider.SEL_PREV_R);
    this._btnNextr = this._el.querySelector(ItcSlider.SEL_NEXT_R);
  ...
  _addEventListener() {
    this._el.addEventListener('click', (e) => {
      this._autoplay('stop');
      if ((e.target.classList.contains(ItcSlider.CLASS_CONTROL))||(e.target.classList.contains(ItcSlider.CLASS_CONTROL_R))) {
        e.preventDefault();
