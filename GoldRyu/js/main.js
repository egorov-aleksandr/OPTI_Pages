(() => {
    var e = {
                ...
                document.querySelectorAll('.accordion').forEach((e) => {
                    e.addEventListener('click', (e) => {
                        ...
                        t.classList.toggle('accordion-open'),
                            t.classList.contains('docs-hero__item') ? i.classList.toggle('accordion__content-open-docs') : i.classList.toggle('accordion__content-open'),
                            a.classList.toggle('accordion__icon-arrow-reversed'),
                            t.classList.contains('accordion-open') ? (s.setAttribute('aria-expanded', !0), i.setAttribute('aria-hidden', !1), (i.style.maxHeight = i.scrollHeight + 'px')) : (s.setAttribute('aria-expanded', !1), i.setAttribute('aria-hidden', !0), (i.style.maxHeight = null));
                    });
                });
            },
            661: () => {
                document.querySelectorAll('.cabinet-hero__label-change').forEach((e) => {
                    e.addEventListener('click', () => {
                        (input = document.getElementById(e.getAttribute('for'))), 'disabled' !== input.getAttribute('disabled') ? (console.log(input.value), input.setAttribute('disabled', 'disabled'), e.classList.remove('cabinet-hero__label-change-active')) : (input.removeAttribute('disabled'), e.classList.add('cabinet-hero__label-change-active'));
                    });
                }),
                    document.querySelectorAll('.cabinet-hero__button-change').forEach((e) => {
                        e.addEventListener('click', () => {
                            (currentSection = document.querySelector('.cabinet-hero__frame-visible')), (targetSection = document.getElementById(e.getAttribute('data-frame'))), currentSection !== targetSection && (currentSection.classList.toggle('cabinet-hero__frame-visible'), targetSection.classList.toggle('cabinet-hero__frame-visible'));
                        });
                    });
            },
            472: () => {
                document.querySelectorAll('.catalog-hero__input').forEach((e) => {
                    e.addEventListener('change', () => {
                        const t = e.getAttribute('data-category');
                        document.getElementById(t).classList.toggle('catalog-hero__container-category-hidden');
                    });
                });
            },
            27: () => {
                ymaps.ready(function () {
                    if (null !== document.getElementById('contacts-map')) myMap = new ymaps.Map('contacts-map', { center: [55.05386257036589, 61.45853671216136], zoom: 9 });
                    else {
                        if (null === document.getElementById('main-map')) return;
                        myMap = new ymaps.Map('main-map', { center: [55.05386257036589, 61.45853671216136], zoom: 9 });
                    }
                    const e = new ymaps.GeoObject({ geometry: { type: 'Point', coordinates: [55.154938569541265, 61.31335099999995] } }),
                        t = new ymaps.GeoObject({ geometry: { type: 'Point', coordinates: [54.86839356980941, 61.40452099999999] } });
            ...
            617: () => {
                ...
                null !== e &&
                    null !== t &&
                    e.addEventListener('click', () => {
                        t.classList.toggle('menu__bg-active'), e.classList.toggle('burger--active');
                    });
            },
            774: () => {
            ...
            848: () => {
                document.querySelectorAll('.main-design__container-row').forEach((e) => {
                    const t = e.querySelectorAll('.main-design__label');
                    t.forEach((e) => {
                        (input = e.querySelector('.main-design__input')),
                            input.addEventListener('change', () => {
                                t.forEach((e) => {
                                    e.classList.remove('main-design__label-active');
                                }),
                                    e.classList.add('main-design__label-active');
                            });
                    });
                });
            },
            ...
            578: () => {
                document.querySelectorAll('.main-feedback__container-video').forEach((e) => {
                    const t = e.querySelector('.main-feedback__video');
                    let s = 0;
                    const i = e.querySelector('.main-feedback__button-fullscreen');
                    null !== i &&
                        i.addEventListener('click', (e) => {
                            e.stopPropagation(), t.requestFullscreen ? t.requestFullscreen() : t.mozRequestFullScreen ? t.mozRequestFullScreen() : t.webkitRequestFullscreen && t.webkitRequestFullscreen();
                        }),
                        t.addEventListener('fullscreenchange', () => {
                            s++, s > 1 && ((s = 0), t.load(), e.classList.remove('main-feedback__container-video-active'));
                        }),
                        e.addEventListener('click', () => {
                            e.classList.contains('main-feedback__container-video-active') ? (e.classList.remove('main-feedback__container-video-active'), t.pause(), 0 == s && t.load()) : (t.play(), e.classList.add('main-feedback__container-video-active'));
                        });
                });
            },
        },
    ...
    (() => {
        ...
        window, document, document.documentElement, document.body, s(595), s(848);
        const i = {
            body: {},
            addEventListener() {},
            removeEventListener() {},
            ...
            C = {
                updateSize: function () {
                    ...
                    (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth),
                        ...
                        (0 === t && e.isHorizontal()) ||
                            (0 === s && e.isVertical()) ||
                            ((t = t - parseInt(g(i, 'padding-left') || 0, 10) - parseInt(g(i, 'padding-right') || 0, 10)), (s = s - parseInt(g(i, 'padding-top') || 0, 10) - parseInt(g(i, 'padding-bottom') || 0, 10)), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, { width: t, height: s, size: e.isHorizontal() ? t : s }));
                },
                updateSlides: function () {
                    ...
                    let x = i.spaceBetween,
                        ...
                        M = 0;
                    if (void 0 === n) return;
                    'string' == typeof x && x.indexOf('%') >= 0 && (x = (parseFloat(x.replace('%', '')) / 100) * n),
                        (e.virtualSize = -x),
                        u.forEach((e) => {
                    ...
                    for (let a = 0; a < m; a += 1) {
                        let r;
                        if (((P = 0), u[a] && (r = u[a]), _ && e.grid.updateSlide(a, r, m, t), !u[a] || 'none' !== g(r, 'display'))) {
                            if ('auto' === i.slidesPerView) {
                                k && (u[a].style[t('width')] = '');
                                const n = getComputedStyle(r),
                                    l = r.style.transform,
                                    o = r.style.webkitTransform;
                                if ((l && (r.style.transform = 'none'), o && (r.style.webkitTransform = 'none'), i.roundLengths)) P = e.isHorizontal() ? w(r, 'width', !0) : w(r, 'height', !0);
                                else {
                                    const e = s(n, 'width'),
                                        t = s(n, 'padding-left'),
                                        i = s(n, 'padding-right'),
                            ...
                            } else (P = (n - (i.slidesPerView - 1) * x) / i.slidesPerView), i.roundLengths && (P = Math.floor(P)), u[a] && (u[a].style[t('width')] = `${P}px`);
                            u[a] && (u[a].swiperSlideSize = P),
                                b.push(P),
                                i.centeredSlides
                                    ? ((C = C + P / 2 + L / 2 + x), 0 === L && 0 !== a && (C = C - n / 2 - x), 0 === a && (C = C - n / 2 - x), Math.abs(C) < 0.001 && (C = 0), i.roundLengths && (C = Math.floor(C)), M % i.slidesPerGroup == 0 && f.push(C), v.push(C))
                                    : (i.roundLengths && (C = Math.floor(C)), (M - Math.min(e.params.slidesPerGroupSkip, M)) % e.params.slidesPerGroup == 0 && f.push(C), v.push(C), (C = C + P + x)),
                                (e.virtualSize += P + x),
                                (L = P),
                                (M += 1);
                        }
                    }
                    if (((e.virtualSize = Math.max(e.virtualSize, n) + S), l && o && ('slide' === i.effect || 'coverflow' === i.effect) && (a.style.width = `${e.virtualSize + i.spaceBetween}px`), i.setWrapperSize && (a.style[t('width')] = `${e.virtualSize + i.spaceBetween}px`), _ && e.grid.updateWrapperSize(P, f, t), !i.centeredSlides)) {
                        const t = [];
                    ...
                    if (d && i.loop) {
                        ...
                        for (let s = 0; s < e.virtual.slidesBefore + e.virtual.slidesAfter; s += 1) 1 === i.slidesPerGroup && f.push(f[f.length - 1] + t), v.push(v[v.length - 1] + t), (e.virtualSize += t);
                    }
                    ...
                    if ((Object.assign(e, { slides: u, snapGrid: f, slidesGrid: v, slidesSizesGrid: b }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                        p(a, '--swiper-centered-offset-before', -f[0] + 'px'), p(a, '--swiper-centered-offset-after', e.size / 2 - b[b.length - 1] / 2 + 'px');
                        const t = -e.snapGrid[0],
                            s = -e.slidesGrid[0];
                        (e.snapGrid = e.snapGrid.map((e) => e + t)), (e.slidesGrid = e.slidesGrid.map((e) => e + s));
                    }
                    if ((m !== c && e.emit('slidesLengthChange'), f.length !== E && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')), v.length !== T && e.emit('slidesGridLengthChange'), i.watchSlidesProgress && e.updateSlidesOffset(), !(d || i.cssMode || ('slide' !== i.effect && 'fade' !== i.effect)))) {
                ...
                updateSlidesProgress: function (e = (this && this.translate) || 0) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        ((p >= 0 && p < t.size - 1) || (u > 1 && u <= t.size) || (p <= 0 && u >= t.size)) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)), (l.progress = a ? -d : d), (l.originalProgress = a ? -c : c);
                    }
                },
        ...
        const M = {
            slideTo: function (e = 0, t = this.params.speed, s = !0, i, a) {
                ...
                let w;
                if ((n !== (c || 0) && s && r.emit('beforeSlideChangeStart'), r.updateProgress(b), (w = n > p ? 'next' : n < p ? 'prev' : 'reset'), (m && -b === r.translate) || (!m && b === r.translate)))
                    return r.updateActiveIndex(n), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), 'slide' !== l.effect && r.setTranslate(b), 'reset' !== w && (r.transitionStart(s, w), r.transitionEnd(s, w)), !1;
                if (l.cssMode) {
        ...
        function _(e) {
            ...
            Object.assign(r, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (d.startX = v), (d.startY = b), (r.touchStartTime = o()), (t.allowClick = !0), t.updateSize(), (t.swipeDirection = void 0), l.threshold > 0 && (r.allowThresholdMove = !1);
            let S = !0;
            u.matches(r.focusableElements) && ((S = !1), 'SELECT' === u.nodeName && (r.isTouched = !1)), s.activeElement && s.activeElement.matches(r.focusableElements) && s.activeElement !== u && s.activeElement.blur();
            const E = S && t.allowTouchMove && l.touchStartPreventDefault;
            (!l.touchStartForcePreventDefault && !E) || u.isContentEditable || p.preventDefault(), t.params.freeMode && t.params.freeMode.enabled && t.freeMode && t.animating && !l.cssMode && t.freeMode.onTouchStart(), t.emit('touchStart', p);
        }
        function P(e) {
            const t = a(),
                s = this,
            ...
            if (!s.allowTouchMove) return c.target.matches(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(n, { startX: m, startY: h, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: m, currentY: h }), (i.touchStartTime = o())));
            ...
            r.oneWayMovement && ((v = Math.abs(v) * (l ? 1 : -1)), (b = Math.abs(b) * (l ? 1 : -1))), (n.diff = v), (v *= r.touchRatio), l && ((v = -v), (b = -b));
            ...
            let S;
            i.isMoved && w !== s.touchesDirection && y && Math.abs(v) >= 1 && (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (S = !0)), s.emit('sliderMove', c), (i.isMoved = !0), (i.currentTranslate = v + i.startTranslate);
            let E = !0,
                T = r.resistanceRatio;
            if (
                (r.touchReleaseOnEdges && (T = 0),
                v > 0
                    ? (y && !S && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: 'prev', setTranslate: !0, activeSlideIndex: 0 }), i.currentTranslate > s.minTranslate() && ((E = !1), r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** T)))
                    : v < 0 &&
                      (y && !S && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({ direction: 'next', setTranslate: !0, activeSlideIndex: s.slides.length - ('auto' === r.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10))) }),
                      i.currentTranslate < s.maxTranslate() && ((E = !1), r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** T))),
        ...
        function k(e) {
            ...
            const { params: a, touches: r, rtlTranslate: n, slidesGrid: d, enabled: c } = t;
            if (!c) return;
            ...
            let v = null,
                b = null;
            a.rewind && (t.isBeginning ? (b = t.params.virtual && t.params.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1) : t.isEnd && (v = 0));
            const w = (h - d[f]) / g,
                y = f < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
            if (m > a.longSwipesMs) {
                if (!a.longSwipes) return void t.slideTo(t.activeIndex);
                'next' === t.swipeDirection && (w >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? v : f + y) : t.slideTo(f)), 'prev' === t.swipeDirection && (w > 1 - a.longSwipesRatio ? t.slideTo(f + y) : null !== b && w < 0 && Math.abs(w) > a.longSwipesRatio ? t.slideTo(b) : t.slideTo(f));
            } else {
                if (!a.shortSwipes) return void t.slideTo(t.activeIndex);
                !t.navigation || (p.target !== t.navigation.nextEl && p.target !== t.navigation.prevEl) ? ('next' === t.swipeDirection && t.slideTo(null !== v ? v : f + y), 'prev' === t.swipeDirection && t.slideTo(null !== b ? b : f)) : p.target === t.navigation.nextEl ? t.slideTo(f + y) : t.slideTo(f);
            }
        }
        let A;
        function I() {
        ...
        const D = (e, t) => {
                ...
                r[d]('pointerdown', e.onTouchStart, { passive: !1 }),
                    ...
                    i.updateOnWindowResize ? e[c](l.ios || l.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', I, !0) : e[c]('observerUpdate', I, !0),
        ...
        function V(e, t) {
            return function (s = {}) {
                const i = Object.keys(s)[0],
                    a = s[i];
                'object' == typeof a && null !== a ? (['navigation', 'pagination', 'scrollbar'].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }), i in e && 'enabled' in a ? (!0 === e[i] && (e[i] = { enabled: !0 }), 'object' != typeof e[i] || 'enabled' in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), c(t, s)) : c(t, s)) : c(t, s);
            };
        }
        const H = {
                eventsEmitter: x,
                ...
                translate: {
                        ...
                        let r = (function (e, t = 'x') {
                            ...
                            return (
                                s.WebKitCSSMatrix
                                    ...
                                    : ((r = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform || l.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,')), (i = r.toString().split(','))),
                    ...
                    setTranslate: function (e, t) {
                        ...
                        let l,
                            o = 0,
                            d = 0;
                        s.isHorizontal() ? (o = i ? -e : e) : (d = e), a.roundLengths && ((o = Math.floor(o)), (d = Math.floor(d))), a.cssMode ? (r[s.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = s.isHorizontal() ? -o : -d) : a.virtualTranslate || (r.style.transform = `translate3d(${o}px, ${d}px, 0px)`), (s.previousTranslate = s.translate), (s.translate = s.isHorizontal() ? o : d);
                ...
                loop: {
                    ...
                    loopFix: function ({ slideRealIndex: e, slideTo: t = !0, direction: s, setTranslate: i, activeSlideIndex: a, byController: r, byMousewheel: n } = {}) {
                        const l = this;
                        ...
                        if (((l.allowSlidePrev = !0), (l.allowSlideNext = !0), l.virtual && u.virtual.enabled))
                            return (
                                t && (u.centeredSlides || 0 !== l.snapIndex ? (u.centeredSlides && l.snapIndex < u.slidesPerView ? l.slideTo(l.virtual.slides.length + l.snapIndex, 0, !1, !0) : l.snapIndex === l.snapGrid.length - 1 && l.slideTo(l.virtual.slidesBefore, 0, !1, !0)) : l.slideTo(l.virtual.slides.length, 0, !1, !0)), (l.allowSlidePrev = d), (l.allowSlideNext = c), void l.emit('loopFix')
                            );
                        ...
                        if (a < h) {
                            ...
                            S = Math.max(a - (l.slides.length - 2 * h), u.slidesPerGroup);
                            for (let e = 0; e < S; e += 1) {
                                const t = e - Math.floor(e / o.length) * o.length;
                                g.push(t);
                            }
                ...
                events: {
                    attachEvents: function () {
                        const e = this,
                            t = a(),
                            { params: s } = e;
                        (e.onTouchStart = _.bind(e)), (e.onTouchMove = P.bind(e)), (e.onTouchEnd = k.bind(e)), s.cssMode && (e.onScroll = z.bind(e)), (e.onClick = O.bind(e)), (e.onLoad = B.bind(e)), G || (t.addEventListener('touchstart', q), (G = !0)), D(e, 'on');
                    },
                ...
                breakpoints: {
                    setBreakpoint: function () {
                        ...
                        o && !d
                            ...
                            : !o && d && (a.classList.add(`${i.containerModifierClass}grid`), ((l.grid.fill && 'column' === l.grid.fill) || (!l.grid.fill && 'column' === i.grid.fill)) && a.classList.add(`${i.containerModifierClass}grid-column`), e.emitContainerClasses()),
        ...
        class R {
            constructor(...e) {
                        ...
                        return (
                            S ||
                                (S = (function ({ userAgent: e } = {}) {
                                    ...
                                    let h = 'MacIntel' === i;
                                    return (
                                        !c && h && t.touch && ['1024x1366', '1366x1024', '834x1194', '1194x834', '834x1112', '1112x834', '768x1024', '1024x768', '820x1180', '1180x820', '810x1080', '1080x810'].indexOf(`${l}x${o}`) >= 0 && ((c = a.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, '13_0_0']), (h = !1)),
                ...
                const l = {};
                r.modules.forEach((e) => {
                    e({ params: s, swiper: r, extendParams: V(s, l), on: r.on.bind(r), once: r.once.bind(r), off: r.off.bind(r), emit: r.emit.bind(r) });
                });
                const d = c({}, N, l);
                return (
                    (r.params = c({}, d, j, s)),
                    ...
                    Object.assign(r, {
                        ...
                        touchEventsData: { isTouched: void 0, isMoved: void 0, allowTouchCallbacks: void 0, touchStartTime: void 0, isScrolling: void 0, currentTranslate: void 0, startTranslate: void 0, allowThresholdMove: void 0, focusableElements: r.params.focusableElements, lastClickTime: o(), clickTimeout: void 0, velocities: [], allowMomentumBounce: void 0, startMoving: void 0, evCache: [] },
                        allowClick: !0,
            ...
            slidesPerViewDynamic(e = 'current', t = !1) {
                ...
                } else if ('current' === e) for (let e = l + 1; e < i.length; e += 1) (t ? a[e] + r[e] - a[l] < n : a[e] - a[l] < n) && (o += 1);
                else for (let e = l - 1; e >= 0; e -= 1) a[l] - a[e] < n && (o += 1);
                return o;
            }
            update() {
                const e = this;
                ...
                s.breakpoints && e.setBreakpoint(),
                    ...
                    e.params.freeMode && e.params.freeMode.enabled ? (i(), e.params.autoHeight && e.updateAutoHeight()) : ((a = ('auto' === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)), a || i()),
            ...
            mount(e) {
                ...
                return (
                    ...
                    Object.assign(t, { el: s, wrapperEl: a, slidesEl: t.isElement ? s : a, mounted: !0, rtl: 'rtl' === s.dir.toLowerCase() || 'rtl' === g(s, 'direction'), rtlTranslate: 'horizontal' === t.params.direction && ('rtl' === s.dir.toLowerCase() || 'rtl' === g(s, 'direction')), wrongRTL: '-webkit-box' === g(a, 'display') }),
                    !0
                );
            }
            init(e) {
            ...
            R.use([
                function ({ swiper: e, on: t, emit: s }) {
                    ...
                    t('init', () => {
                        ...
                        t('destroy', () => {
                            r && i.cancelAnimationFrame(r), a && a.unobserve && e.el && (a.unobserve(e.el), (a = null)), i.removeEventListener('resize', l), i.removeEventListener('orientationchange', o);
                        });
                },
                function ({ swiper: e, extendParams: t, on: s, emit: i }) {
                    const a = [],
                        ...
                        l = (t, s = {}) => {
                            ...
                            n.observe(t, { attributes: void 0 === s.attributes || s.attributes, childList: void 0 === s.childList || s.childList, characterData: void 0 === s.characterData || s.characterData }), a.push(n);
                        };
        ...
        function te(e, t, s) {
            ...
            return r || ((r = f('div', 'swiper-slide-shadow' + (s ? `-${s}` : ''))), a.append(r)), r;
        }
        W.use([
            function ({ swiper: e, extendParams: t, on: s, emit: i }) {
                ...
                function c(t) {
                    const s = t.target.closest(Y(e.params.pagination.bulletClass));
                    if (!s) return;
                    t.preventDefault();
                    const i = v(s) * e.params.slidesPerGroup;
                    if (e.params.loop) {
                        if (e.realIndex === i) return;
                        (i < e.loopedSlides || i > e.slides.length - e.loopedSlides) && e.loopFix({ direction: i < e.loopedSlides ? 'prev' : 'next', activeSlideIndex: i, slideTo: !1 }), e.slideToLoop(i);
                    } else e.slideTo(i);
                }
                function p() {
                    const t = e.rtl,
                    ...
                    if (((a = e.params.loop ? (e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0), 'bullets' === s.type && e.pagination.bullets && e.pagination.bullets.length > 0)) {
                        const i = e.pagination.bullets;
                        let l, o, p;
                        if (
                            (s.dynamicBullets &&
                                ((r = w(i[0], e.isHorizontal() ? 'width' : 'height', !0)),
                                c.forEach((t) => {
                                    t.style[e.isHorizontal() ? 'width' : 'height'] = r * (s.dynamicMainBullets + 4) + 'px';
                                }),
                                s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((n += a - (e.previousIndex || 0)), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)),
                                (l = Math.max(a - n, 0)),
                            ...
                            i.forEach((e) => {
                                const t = v(e);
                                t === a && e.classList.add(...s.bulletActiveClass.split(' ')), s.dynamicBullets && (t >= l && t <= o && e.classList.add(...`${s.bulletActiveClass}-main`.split(' ')), t === l && d(e, 'prev'), t === o && d(e, 'next'));
                            });
                        else {
                            const e = i[a];
                    ...
                    c.forEach((t, r) => {
                        if (
                            ('fraction' === s.type &&
                                (t.querySelectorAll(Y(s.currentClass)).forEach((e) => {
                                    e.textContent = s.formatFractionCurrent(a + 1);
                                }),
                                t.querySelectorAll(Y(s.totalClass)).forEach((e) => {
                            ...
                            'horizontal' === i ? (n = r) : (l = r),
                                t.querySelectorAll(Y(s.progressbarFillClass)).forEach((t) => {
                                    (t.style.transform = `translate3d(0,0,0) scaleX(${n}) scaleY(${l})`), (t.style.transitionDuration = `${e.params.speed}ms`);
                                });
                        }
                        'custom' === s.type && s.renderCustom ? ((t.innerHTML = s.renderCustom(e, a + 1, u)), 0 === r && i('paginationRender', t)) : (0 === r && i('paginationRender', t), i('paginationUpdate', t)), e.params.watchOverflow && e.enabled && t.classList[e.isLocked ? 'add' : 'remove'](s.lockClass);
                    });
                }
                function u() {
                    ...
                    'fraction' === t.type && (r = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`),
                        ...
                        a.forEach((s) => {
                            'custom' !== t.type && (s.innerHTML = r || ''), 'bullets' === t.type && e.pagination.bullets.push(...s.querySelectorAll(Y(t.bulletClass)));
                        }),
                ...
                function m() {
                    ...
                    'string' == typeof t.el && e.isElement && (s = e.el.shadowRoot.querySelector(t.el)),
                        ...
                        s &&
                            0 !== s.length &&
                            (e.params.uniqueNavElements && 'string' == typeof t.el && Array.isArray(s) && s.length > 1 && ((s = [...e.el.querySelectorAll(t.el)]), s.length > 1 && (s = s.filter((t) => b(t, '.swiper')[0] === e.el)[0])),
                    ...
                    setTranslate: () => {
                        ...
                        for (let s = 0; s < t.length; s += 1) {
                            ...
                            const g = u.join(', '),
                                ...
                                b = c < 0 ? `scale(${1 + (1 - f.scale) * c * n})` : `scale(${1 - (1 - f.scale) * c * n})`,
                            ...
                            const S = ee(0, a);
                            (S.style.transform = y), (S.style.opacity = w), f.origin && (S.style.transformOrigin = f.origin);
                        }
                    },
                    setTransition: (t) => {
            ...
            function ({ swiper: e, extendParams: t, on: s }) {
                ...
                function n() {
                    ...
                    if (null == s) return;
                    let a;
                    (a = t.params.loop ? parseInt(t.clickedSlide.getAttribute('data-swiper-slide-index'), 10) : s), e.params.loop ? e.slideToLoop(a) : e.slideTo(a);
                }
                function l() {
                    ...
                    if (t.swiper instanceof s) (e.thumbs.swiper = t.swiper), Object.assign(e.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), Object.assign(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), e.thumbs.swiper.update();
                    else if (d(t.swiper)) {
                        const i = Object.assign({}, t.swiper);
                        Object.assign(i, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), (e.thumbs.swiper = new s(i)), (r = !0);
                    }
                ...
                function o(t) {
                    ...
                    if ((e.params.slidesPerView > 1 && !e.params.centeredSlides && (a = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (a = 1), (a = Math.floor(a)), s.slides.forEach((e) => e.classList.remove(r)), s.params.loop || (s.params.virtual && s.params.virtual.enabled)))
                        for (let t = 0; t < a; t += 1)
                            h(s.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach((e) => {
                                e.classList.add(r);
                            });
                    else for (let t = 0; t < a; t += 1) s.slides[e.realIndex + t] && s.slides[e.realIndex + t].classList.add(r);
                    ...
                    if (e.realIndex !== s.realIndex || l) {
                        ...
                        l && (r += 'next' === o ? n : -1 * n), s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(r) < 0 && (s.params.centeredSlides ? (r = r > a ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1) : r > a && s.params.slidesPerGroup, s.slideTo(r, t ? 0 : void 0));
                    }
                }
                                ...
                                const s = a(),
                                    i = () => {
                                        ...
                                        if (i && i.swiper) (t.swiper = i.swiper), l(), o(!0);
                                            ...
                                            const s = (a) => {
                                                (t.swiper = a.detail[0]), i.removeEventListener('init', s), l(), o(!0), t.swiper.update(), e.update();
                                            };
            ...
            function ({ swiper: e }) {
                Object.assign(e, { appendSlide: U.bind(e), prependSlide: K.bind(e), addSlide: Z.bind(e), removeSlide: J.bind(e), removeAllSlides: Q.bind(e) });
            },
            function ({ swiper: e, extendParams: t, on: s, emit: i, params: r }) {
                ...
                const w = () => {
                    ...
                    y = (t) => {
                        ...
                        !Number.isNaN(a) && a > 0 && void 0 === t && ((s = a), (f = a), (g = a)), (o = s);
                    ...
                    T = (t, s) => {
                        ...
                        (o = r - (new Date().getTime() - v)), (e.isEnd && o < 0 && !e.params.loop) || (o < 0 && (o = 0), a());
                    },
                    x = () => {
                        (e.isEnd && o < 0 && !e.params.loop) || e.destroyed || !e.autoplay.running || ((v = new Date().getTime()), h ? ((h = !1), y(o)) : y(), (e.autoplay.paused = !1), i('autoplayResume'));
                    },
                    C = () => {
                        if (e.destroyed || !e.autoplay.running) return;
                        const t = a();
                        'hidden' === t.visibilityState && ((h = !0), T(!0)), 'visible' === t.visibilityState && x();
                    },
                    L = (e) => {
                ...
                s('init', () => {
                    e.params.autoplay.enabled && (e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener('pointerenter', L), e.el.addEventListener('pointerleave', M)), a().addEventListener('visibilitychange', C), (v = new Date().getTime()), S());
                }),
                    s('destroy', () => {
                        e.el.removeEventListener('pointerenter', L), e.el.removeEventListener('pointerleave', M), a().removeEventListener('visibilitychange', C), e.autoplay.running && E();
                    }),
                    s('beforeTransitionStart', (t, s, i) => {
                        !e.destroyed && e.autoplay.running && (i || !e.params.autoplay.disableOnInteraction ? T(!0, !0) : E());
                    }),
                    s('sliderFirstMove', () => {
                        !e.destroyed &&
                            e.autoplay.running &&
            ...
            new W(document.querySelector('.main-hero__slider'), {
                ...
                effect: 'creative',
                grabCursor: !0,
                creativeEffect: { prev: { translate: [0, 0, -100], opacity: 0 }, next: { translate: ['100%', 0, 0], opacity: 1 } },
                pagination: { el: '.main-hero__pagination', type: 'progressbar' },
            ...
            new W(document.querySelector('.main-feedback__slider'), {
                ...
                pagination: { el: '.main-feedback__pagination', type: 'bullets', clickable: !0, bulletClass: 'main-feedback__bullet', bulletActiveClass: 'main-feedback__bullet-active' },
                navigation: { nextEl: '.main-feedback__button-next', prevEl: '.main-feedback__button-prev' },
                breakpoints: { 481: { enabled: !0 }, 0: { slidesPerView: 1, enabled: !1 } },
            });
        const se = new W('.catalog-item-hero__slider-thumbs .swiper-container', { slidesPerView: 3, direction: 'vertical', navigation: { nextEl: '.catalog-item-hero__button-next', prevEl: '.catalog-item-hero__button-prev' }, freeMode: !0, breakpoints: { 1025: { spaceBetween: 40 }, 481: { spaceBetween: 10, direction: 'vertical' }, 0: { direction: 'horizontal' } } }),
            ie = (new W('.catalog-item-hero__slider-images .swiper-container', { slidesPerView: 1, spaceBetween: 30, mousewheel: !0, navigation: { nextEl: '.catalog-item-hero__button-next', prevEl: '.catalog-item-hero__button-prev' }, grabCursor: !0, thumbs: { swiper: se } }), new W('.quiz__slider', { slidesPerView: 1, speed: 500, allowSlideNext: !1, allowSlidePrev: !1 })),
            ae = document.getElementById('startTestBtn');
        null !== ae &&
            ae.addEventListener('click', () => {
                (ie.allowSlideNext = !0), ie.slideNext(), (ie.allowSlideNext = !1);
            });
        const re = new W('.quiz__slider-inner', { slidesPerView: 1, spaceBetween: 15, speed: 500, navigation: { nextEl: '.quiz__button-next', prevEl: '.quiz__button-prev' }, pagination: { el: '.quiz__pagination', type: 'progressbar' } }),
        ...
        const oe = new W('.main-design__slider', { slidesPerView: 1, speed: 500, allowSlideNext: !1, allowSlidePrev: !1 }),
        ...
        null !== ce &&
            ce.addEventListener('click', (e) => {
                ...
                const t = document.querySelector('.main-design__form'),
                    s = t.querySelectorAll('.main-design__label-active .main-design__input'),
                    i = t.querySelector('.main-design__label-active .main-design__image').getAttribute('src');
                if (null !== s) {
                    const e = { img: i };
                    s.forEach((t) => {
                        e[t.name] = t.value;
                        ...
                        document.querySelectorAll('.main-degign__image-imported').forEach((t) => {
                            t.setAttribute('src', e.img);
                        }),
                        document.querySelectorAll('.main-design__text-shape').forEach((t) => {
                            t.innerHTML = `Форма: ${e.shape}`;
                        }),
                        document.querySelectorAll('.main-design__text-color').forEach((t) => {
        ...
        null !== pe &&
            pe.forEach((e) => {
                e.addEventListener('click', () => {
                    (oe.allowSlidePrev = !0), oe.slidePrev(), (oe.allowSlidePrev = !1), (de.style.display = 'block');
                });
            }),
            s(27);
        class ue {
            constructor(e, t) {
                (this.selector = e), (this.innerElements = t), (this.tabs = document.querySelector(`[data-tabs="${e}"]`)), this.tabs && ((this.tabList = this.tabs.querySelector('.' + t.list)), (this.tabsBtns = this.tabList.querySelectorAll('.' + t.button)), (this.tabsPanels = this.tabs.querySelectorAll('.' + t.panel)), this.init(), this.events());
            }
            init() {
                this.tabList.setAttribute('role', 'tablist'),
                    this.tabsBtns.forEach((e, t) => {
                        e.setAttribute('role', 'tab'), e.setAttribute('tabindex', '-1'), e.setAttribute('id', `${this.selector}${t + 1}`), e.classList.remove(this.innerElements.button + '-active');
                    }),
                    this.tabsPanels.forEach((e, t) => {
                        e.setAttribute('role', 'tabpanel'), e.setAttribute('tabindex', '-1'), e.setAttribute('aria-labelledby', this.tabsBtns[t].id), e.classList.remove(this.innerElements.panel + '-active');
                    }),
            ...
            switchTabs(e) {
                ...
                this.tabsPanels[i].classList.remove(this.innerElements.panel + '-active'), this.tabsPanels[s].classList.add(this.innerElements.panel + '-active'), this.tabsBtns[i].classList.remove(this.innerElements.button + '-active'), this.tabsBtns[s].classList.add(this.innerElements.button + '-active');
            }
        }
        new ue('tab', { list: 'catalog-item-tabs__list', button: 'catalog-item-tabs__btn', panel: 'catalog-item-tabs__panel' }), new ue('quizTab', { list: 'quiz__list-tabs', button: 'quiz__btn', panel: 'quiz__panel' }), s(472), s(661), s(617), s(578), s(774), s(290);
    })();
})();
